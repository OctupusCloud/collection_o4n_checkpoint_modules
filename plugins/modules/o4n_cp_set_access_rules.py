...
DOCUMENTATION = """
---
module: o4n_cp_set_access_rules
short_description: Set access rules of the selected layer.
description:
            ...
            track:
                ...
                options:
                    ...
                    alert:
                      type: str
                      description:
                        - Valid values: none, alert, snmp, mail, user alert 1, user alert 2, user alert 3
...
def set_access_rule(provider, layers, module):
...
def main():
    ...
    success, msg_ret, output, task_detail, msg_discard, msg_logout = set_access_rule(
